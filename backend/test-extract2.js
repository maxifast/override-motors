...
function testH() {
    return __awaiter(this, void 0, void 0, function () {
        var browser, context, page, url, html, textContent, yearMatch, fuelMatch, lines, _i, lines_1, l, clean;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    ...
                    yearMatch = textContent.match(/(?:year|bouwjaar)[\s\S]{0,50}(202\d|201\d)/i);
                    console.log("Year Regex test 1:", yearMatch ? yearMatch[0] : "null");
                    fuelMatch = textContent.match(/(?:fuel|brandstof)[\s\S]{0,50}(electric|hybrid|petrol|diesel)/i);
