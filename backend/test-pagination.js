...
function run() {
    return __awaiter(this, void 0, void 0, function () {
        var browser, page, nextLinks, carLinks;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.sent();
                    return [4 /*yield*/, page.$$eval('.pagination a, .pages a, nav a', function (anchors) { return Array.from(anchors).map(function (a) { return a.href; }); })];
                case 4:
                    nextLinks = _a.sent();
